...
NEXT_PUBLIC_TEACHER_MOD_SPEC=${teacherMod}
NEXT_PUBLIC_STUDENT_MOD_SPEC=${studentMod}
NEXT_PUBLIC_QUIZ_MOD_SPEC=${quizMod}
NEXT_PUBLIC_QUIZ_ATTEMPT_MOD_SPEC=${attemptMod}
NEXT_PUBLIC_PAYMENT_MOD_SPEC=${paymentMod}
NEXT_PUBLIC_QUIZ_ACCESS_MOD_SPEC=${quizAccessMod}
NEXT_PUBLIC_QUIZ_ACCESS_SALE_MOD_SPEC=${quizAccessSaleMod}
`)
