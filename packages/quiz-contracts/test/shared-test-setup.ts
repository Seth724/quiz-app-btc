...
export async function setupSharedComputers() {
  ...
  if (network === 'regtest') {
    ...
    await Promise.all([
      sharedTeacher1Computer.faucet(1e8),
      sharedTeacher2Computer.faucet(1e8),
...
export async function createSharedEntities() {
  ...
  sharedTeacher1 = await sharedTeacher1Computer.new(Teacher, ['Professor Smith', sharedTeacher1Computer.getPublicKey()])
  ...
  sharedTeacher2 = await sharedTeacher2Computer.new(Teacher, ['Professor Jones', sharedTeacher2Computer.getPublicKey()])
  ...
  sharedStudent1 = await sharedStudent1Computer.new(Student, ['John Doe', sharedStudent1Computer.getPublicKey()])
  ...
  sharedStudent2 = await sharedStudent2Computer.new(Student, ['Jane Smith', sharedStudent2Computer.getPublicKey()])
