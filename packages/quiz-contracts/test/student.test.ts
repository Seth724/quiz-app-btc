...
//     console.log('Completed quizzes:', student1.completedQuizzes)
//     console.log('Total earnings:', student1.totalEarnings.toString())
...
//     expect(student1.completedQuizzes).to.be.an('array').that.is.empty
//     expect(student1.totalEarnings).to.equal(0n)
...
//     expect(student1.completedQuizzes).to.include(quiz1Id)
//     expect(student1.totalEarnings).to.equal(1000n)
...
//     expect(student1.completedQuizzes).to.include.members([quiz1Id, quiz2Id])
//     expect(student1.totalEarnings).to.equal(3000n)
...
//     expect(student1.totalEarnings).to.equal(largeAmount)
//   })
...
//     expect(student1.totalEarnings).to.equal(expectedTotal)
...
//     expect(emptyNameStudent.name).to.equal('')
//     expect(emptyNameStudent.publicKey).to.be.a('string')
...
//     const completions = student1.completedQuizzes.filter(id => id === duplicateQuizId)
